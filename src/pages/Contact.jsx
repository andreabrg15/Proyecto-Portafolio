            ...
            <div className="grid grid-cols-8">
                ...
                <div className="col-start-3 col-span-3 py-3">
                    <form ref={form} className="grid justify-center py-3 gap-2" onSubmit={sendEmail}>
                        <label className="flex justify-start text-white">Ingrese su nombre:</label>
                        <input className="bg-white/80 rounded-2xl w-120 px-7 py-2" placeholder="Nombre" type="text" id="name" 
                        name="name" required/>
